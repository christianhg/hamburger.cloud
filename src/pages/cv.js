    ...
    >
      <Section name="cv">
        ...
        <Subsection name="intro">
          ...
          <p>
            When I’m not engaged in providing the best possible user experience
            both through APIs and user interfaces, I’m usually invested in our
            team of ~20 front-end developers: endorsing knowledge-sharing,
            trying out new tools and techniques as well as improving our
            development environment comes naturally to me.
          </p>
        </Subsection>
        <Subsection name="pe">
